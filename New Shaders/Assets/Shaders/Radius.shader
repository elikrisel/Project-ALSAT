Shader "Custom/Radius"
{
    Properties
    {
        ...
        _Center_second("Center_second", Vector) = (200,0,200,0)


        _Radius("Radius", Range(0,10)) = 100
        _Emission("Emission", Range(0,10)) = 0
        _RadiusWidth("Radius Width", Range(0,100)) = 10
        ...
        SubShader
        {
            ...
            void surf(Input IN, inout SurfaceOutputStandard o)
            {
                ...
                if (d < _Radius )
                {
                    ...
                    o.Emission = _RadiusColor.rgb * _Emission;

                }
                else  if (d2 < (_Radius_second ))
                {
                    o.Albedo = _RadiusColor_second.rgb;
                    o.Emission = _RadiusColor_second.rgb * _Emission;
