...
namespace DungeonArchitect.Editors.DungeonFlow
{
    public class DungeonFlowEditorWindow : EditorWindow
    {
        ...
        private void ExecToolbar_ButtonPressed(UISystem uiSystem, string id)
        {
            ...
            {
                deferredCommands.Add(new EditorCommand_GridFlowEditorExecResultGraph(this));
            }
        }
    ...
    public class EditorCommand_GridFlowEditorExecResultGraph : DeferredUICommandBase
    {
        private readonly DungeonFlowEditorWindow window;
        public EditorCommand_GridFlowEditorExecResultGraph(DungeonFlowEditorWindow window)
        {
            this.window = window;
        }
